...
class AdditionTestActivity : AppCompatActivity() {
        ...
        buttonSubmit?.setOnClickListener(View.OnClickListener {
            ...
            if (selectedOptionId != -1) {
                ...
                if (currentQuestion.correctAnswer == selectedOption) {
                    score++
                    Toast.makeText(this@AdditionTestActivity, "Correct!", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this@AdditionTestActivity, "Incorrect!", Toast.LENGTH_SHORT)
                        .show()
                }
    ...
    // Method to generate addition questions
    ...
    private fun showFinalScore() {
        Toast.makeText(this@AdditionTestActivity, "Final Score: $score", Toast.LENGTH_SHORT).show()
        // Reset question count and score for the next test
        questionCount = 0
        score = 0

        // Create an intent to navigate back to the previous activity
        val intent = Intent(this@AdditionTestActivity, WelcomeActivity::class.java)
